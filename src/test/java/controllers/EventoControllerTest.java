...
public class EventoControllerTest {
    ...
    public void testeListarEventos() {
        ...
        when(persistenciaMockEvento.getTodos()).thenReturn((ArrayList<Evento>) eventosMock);
    ...
    public void testeCadastrarEvento() {
        ...
        Evento evento1 = new Evento(1, "Super", "Armazem", "15:30", "Super palestra");
        when(persistenciaMockEvento.getTodos()).thenReturn((ArrayList<Evento>) Arrays.asList(evento1));
    ...
    public void testeAtualizarEvento() {
        ...
        // Verificando se o método update foi chamado com os eventos correto
